...
sa_cov_dat$Dialy_cases7[sa_cov_dat$time>342]<-NA
...
forcast_cum_all
ggsave(filename = "forcast_cum_all.png", forcast_cum_all,width = 4, height = 4, dpi = 300, units = "in", device='png')
...
```{r message = FALSE, warning = FALSE}
# table 
Frocasting7<-Day7_pred[Day7_pred$time>342,c("date2","total","Cum_pred_rw2", "Cum_pred_rw2_lower", "Cum_pred_rw2_upper"
